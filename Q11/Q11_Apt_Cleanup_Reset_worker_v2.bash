#!/usr/bin/env bash
# Q11 (APT-based) Worker Cleanup — restore repo + align kubelet/kubectl via apt (v2)
#
# Lets you set RESTORE_MINOR (defaults 1.34) to re-point repo channel.
#
# Usage:
#   sudo bash /tmp/Q11_Apt_Cleanup_Reset_worker.bash
#   sudo RESTORE_MINOR=1.34 bash /tmp/Q11_Apt_Cleanup_Reset_worker.bash
#   sudo RESTORE_MINOR=1.34 TARGET_VERSION=1.34.3-1.1 bash /tmp/Q11_Apt_Cleanup_Reset_worker.bash
...
echo "== Q11 APT Worker Cleanup v2 =="
echo "Date: $(date -Is)"
echo "Node: ${NODE_NAME}"
